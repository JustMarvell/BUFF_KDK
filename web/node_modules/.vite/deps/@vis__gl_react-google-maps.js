...
function getChangedOptions(nextOptions, trackedOptions) {
  ...
  for (const key of keys2) {
    if (!hasOwn(nextOptions, key)) {
      changedOptions !== null && changedOptions !== void 0 ? changedOptions : changedOptions = /* @__PURE__ */ Object.create(null);
      changedOptions[key] = UNSET;
      continue;
    }
    if (hasOwn(trackedOptions, key) && deepEqual(trackedOptions[key], nextOptions[key]))
      continue;
    changedOptions !== null && changedOptions !== void 0 ? changedOptions : changedOptions = /* @__PURE__ */ Object.create(null);
...
var GoogleMaps3DContext$1 = import_react.default.createContext(null);
...
var Map3D$1 = (0, import_react.forwardRef)((props, ref) => {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement("gmp-map-3d", { ref: map3dRef, style: { width: "100%", height: "100%" } }, map3d && import_react.default.createElement(GoogleMaps3DContext$1.Provider, { value: contextValue }, children))
  );
});
